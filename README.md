...
上海、北京、杭州、广州、深圳、苏州、合肥、南京、成都、重庆、武汉、西安、芜湖、珠海公共地点近邻检索；选择城市并输入地址后，按教育、交通、文化艺术、医疗健康、环境休闲、商业购物、公共服务和城市地标分组展示最近地点。

[GitHub Repo](https://github.com/holynova/city-public-facilities) · [GitHub Pages](https://holynova.github.io/city-public-facilities/) · [Cloudflare](https://city-public-facilities.xiaosang.cc/)

## 数据说明

网站展示按需人工更新的公共设施数据快照。距离基于 GCJ-02 坐标计算，为两点间直线距离，不代表实际步行或驾车路线。
