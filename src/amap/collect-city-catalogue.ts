...
const HEFEI_QUERIES: Query[] = [
  ...
  { category: "commerce.big_box_retail", keywords: "宜家家居", accepts: typedNamed("06", /宜家/) },
  { category: "commerce.big_box_retail", keywords: "开市客", accepts: typedNamed("06", /开市客|Costco/i) },
  { category: "commerce.large_mall", keywords: "购物中心", allPages: true, accepts: typedNamed("06", /购物中心|广场|万象|银泰|万达|之心城|百大/) },
  { category: "transport.railway_station", keywords: "合肥站", accepts: typedNamed("150200", /^合肥站$/) },
  { category: "transport.railway_station", keywords: "合肥南站", accepts: typedNamed("150200", /^合肥南站$/) },
  { category: "transport.railway_station", keywords: "合肥北城站", accepts: typedNamed("150200", /^合肥北城站$/) },
  { category: "transport.airport", keywords: "合肥新桥国际机场", accepts: typedNamed("150104", /合肥新桥国际机场/) },
  { category: "landmark.city_landmark", keywords: "包公园", accepts: named(/^包公园$/) },
  { category: "landmark.city_landmark", keywords: "逍遥津公园", accepts: named(/^逍遥津公园$/) },
  { category: "landmark.city_landmark", keywords: "李鸿章故居", accepts: named(/李鸿章故居/) },
  { category: "landmark.city_landmark", keywords: "三河古镇", accepts: named(/^三河古镇$/) },
  { category: "landmark.city_landmark", keywords: "安徽博物院", accepts: named(/^安徽博物院$/) },
  { category: "landmark.city_landmark", keywords: "天鹅湖", accepts: named(/^天鹅湖$/) },
  { category: "park.major_city_park", keywords: "滨湖国家森林公园", accepts: typedNamed("11", /滨湖.*森林公园/) },
  { category: "park.major_city_park", keywords: "骆岗公园", accepts: typedNamed("11", /^骆岗公园$/) },
  { category: "park.major_city_park", keywords: "合肥植物园", accepts: typedNamed("11", /^合肥植物园$/) },
  { category: "park.major_city_park", keywords: "大蜀山国家森林公园", accepts: typedNamed("11", /大蜀山/) },
  { category: "park.major_city_park", keywords: "天鹅湖体育公园", accepts: typedNamed("11", /天鹅湖体育公园/) },
  { category: "park.neighborhood_park", keywords: "口袋公园", allPages: true, accepts: typedNamed("1101", /(口袋|街心|街区|小).*公园/) },
  { category: "community.civic_service_center", keywords: "社区文化活动中心", allPages: true, accepts: named(/社区.*文化.*(活动)?中心/) },
  { category: "community.civic_service_center", keywords: "党群服务中心", allPages: true, accepts: named(/党群.*服务中心/) },
];

const NANJING_QUERIES: Query[] = [
  { category: "culture.museum", keywords: "博物馆", allPages: true, accepts: typedNamed("140100", /博物馆|纪念馆|展览馆/) },
  { category: "culture.art_gallery", keywords: "美术馆", allPages: true, accepts: named(/美术馆|艺术馆|画廊|艺术中心/) },
  { category: "library.district", keywords: "图书馆", allPages: true, accepts: named(/图书馆|书屋|阅读空间/) },
  { category: "culture.concert_hall", keywords: "音乐厅", allPages: true, accepts: named(/音乐厅|音乐堂|大剧院|剧院|演艺中心|艺术中心/) },
  ...
  { category: "commerce.big_box_retail", keywords: "宜家家居", accepts: typedNamed("06", /宜家/) },
  { category: "commerce.big_box_retail", keywords: "开市客", accepts: typedNamed("06", /开市客|Costco/i) },
  { category: "commerce.large_mall", keywords: "购物中心", allPages: true, accepts: typedNamed("06", /购物中心|广场|万象|德基|金鹰|景枫|虹悦城|龙湖/) },
  { category: "transport.railway_station", keywords: "南京站", accepts: typedNamed("150200", /^南京站$/) },
  { category: "transport.railway_station", keywords: "南京南站", accepts: typedNamed("150200", /^南京南站$/) },
  { category: "transport.railway_station", keywords: "仙林站", accepts: typedNamed("150200", /^仙林站$/) },
  { category: "transport.railway_station", keywords: "江宁站", accepts: typedNamed("150200", /^江宁站$/) },
  { category: "transport.airport", keywords: "南京禄口国际机场", accepts: typedNamed("150104", /南京禄口国际机场/) },
  { category: "landmark.city_landmark", keywords: "中山陵", accepts: named(/^中山陵(景区)?$/) },
  { category: "landmark.city_landmark", keywords: "夫子庙", accepts: named(/^夫子庙$/) },
  { category: "landmark.city_landmark", keywords: "南京总统府", accepts: named(/^(南京)?总统府(景区)?$/) },
  { category: "landmark.city_landmark", keywords: "明孝陵", accepts: named(/^明孝陵(景区)?$/) },
  { category: "landmark.city_landmark", keywords: "玄武湖", accepts: named(/^玄武湖$/) },
  { category: "park.major_city_park", keywords: "玄武湖公园", accepts: typedNamed("11", /^玄武湖公园$/) },
  { category: "park.major_city_park", keywords: "莫愁湖公园", accepts: typedNamed("11", /^莫愁湖公园$/) },
  { category: "park.major_city_park", keywords: "南京中国绿化博览园", accepts: typedNamed("11", /绿化博览园|绿博园/) },
  { category: "park.major_city_park", keywords: "鱼嘴湿地公园", accepts: typedNamed("11", /鱼嘴.*湿地公园/) },
  { category: "park.major_city_park", keywords: "老山国家森林公园", accepts: typedNamed("11", /老山.*森林公园/) },
  { category: "park.neighborhood_park", keywords: "口袋公园", allPages: true, accepts: typedNamed("1101", /(口袋|街心|街区|小).*公园/) },
  { category: "community.civic_service_center", keywords: "社区文化活动中心", allPages: true, accepts: named(/社区.*文化.*(活动)?中心/) },
  { category: "community.civic_service_center", keywords: "党群服务中心", allPages: true, accepts: named(/党群.*服务中心/) },
];
...
const CHONGQING_QUERIES: Query[] = [
  ...
  { category: "commerce.big_box_retail", keywords: "宜家家居", accepts: typedNamed("06", /宜家/) },
  { category: "commerce.big_box_retail", keywords: "开市客", accepts: typedNamed("06", /开市客|Costco/i) },
  { category: "commerce.large_mall", keywords: "购物中心", allPages: true, accepts: typedNamed("06", /购物中心|广场|万象|来福士|大悦城|龙湖|时代天街|星光68|国金中心|万达/) },
  { category: "transport.railway_station", keywords: "重庆北站", accepts: typedNamed("150200", /^重庆北站$/) },
  { category: "transport.railway_station", keywords: "重庆西站", accepts: typedNamed("150200", /^重庆西站$/) },
  { category: "transport.railway_station", keywords: "重庆站", accepts: typedNamed("150200", /^重庆站$/) },
  { category: "transport.railway_station", keywords: "沙坪坝站", accepts: typedNamed("150200", /^沙坪坝站$/) },
  { category: "transport.airport", keywords: "重庆江北国际机场", accepts: typedNamed("150104", /重庆江北国际机场/) },
  { category: "landmark.city_landmark", keywords: "解放碑", accepts: named(/解放碑/) },
  { category: "landmark.city_landmark", keywords: "洪崖洞", accepts: named(/洪崖洞/) },
  { category: "landmark.city_landmark", keywords: "磁器口古镇", accepts: named(/磁器口古镇/) },
  { category: "landmark.city_landmark", keywords: "朝天门", accepts: named(/朝天门/) },
  { category: "landmark.city_landmark", keywords: "重庆人民大礼堂", accepts: named(/重庆人民大礼堂|人民大礼堂/) },
  { category: "landmark.city_landmark", keywords: "长江索道", accepts: named(/长江索道/) },
  { category: "landmark.city_landmark", keywords: "重庆动物园", accepts: named(/重庆动物园/) },
  { category: "park.major_city_park", keywords: "重庆园博园", accepts: typedNamed("11", /重庆园博园/) },
  { category: "park.major_city_park", keywords: "重庆中央公园", accepts: typedNamed("11", /重庆中央公园/) },
  { category: "park.major_city_park", keywords: "南山植物园", accepts: typedNamed("11", /南山植物园/) },
  { category: "park.major_city_park", keywords: "照母山森林公园", accepts: typedNamed("11", /照母山森林公园/) },
  { category: "park.major_city_park", keywords: "鹅岭公园", accepts: typedNamed("11", /鹅岭公园/) },
  { category: "park.major_city_park", keywords: "歌乐山森林公园", accepts: typedNamed("11", /歌乐山森林公园/) },
  { category: "park.neighborhood_park", keywords: "口袋公园", allPages: true, accepts: typedNamed("1101", /(口袋|街心|街区|小).*公园/) },
  { category: "community.civic_service_center", keywords: "社区文化活动中心", allPages: true, accepts: named(/社区.*文化.*(活动)?中心/) },
  { category: "community.civic_service_center", keywords: "党群服务中心", allPages: true, accepts: named(/党群.*服务中心/) },
];
...
const XIAN_QUERIES: Query[] = [
  ...
  { category: "commerce.big_box_retail", keywords: "宜家家居", accepts: typedNamed("06", /宜家/) },
  { category: "commerce.big_box_retail", keywords: "开市客", accepts: typedNamed("06", /开市客|Costco/i) },
  { category: "commerce.large_mall", keywords: "购物中心", allPages: true, accepts: typedNamed("06", /购物中心|广场|万象|大悦城|龙湖|大融城|赛格|熙地港|凯德|印象城|万达/) },
  { category: "transport.railway_station", keywords: "西安站", accepts: typedNamed("150200", /^西安站$/) },
  { category: "transport.railway_station", keywords: "西安北站", accepts: typedNamed("150200", /^西安北站$/) },
  { category: "transport.railway_station", keywords: "西安南站", accepts: typedNamed("150200", /^西安南站$/) },
  { category: "transport.airport", keywords: "西安咸阳国际机场", accepts: typedNamed("150104", /西安咸阳国际机场/) },
  { category: "landmark.city_landmark", keywords: "大雁塔", accepts: named(/大雁塔/) },
  { category: "landmark.city_landmark", keywords: "西安城墙", accepts: named(/西安城墙|古城墙/) },
  { category: "landmark.city_landmark", keywords: "钟楼", accepts: named(/西安钟楼|钟楼/) },
  { category: "landmark.city_landmark", keywords: "大唐不夜城", accepts: named(/大唐不夜城/) },
  { category: "landmark.city_landmark", keywords: "大明宫国家遗址公园", accepts: named(/大明宫国家遗址公园/) },
  { category: "landmark.city_landmark", keywords: "陕西历史博物馆", accepts: named(/陕西历史博物馆/) },
  { category: "landmark.city_landmark", keywords: "回民街", accepts: named(/回民街|西安回民街/) },
  { category: "park.major_city_park", keywords: "兴庆宫公园", accepts: typedNamed("11", /兴庆宫公园/) },
  { category: "park.major_city_park", keywords: "曲江池遗址公园", accepts: typedNamed("11", /曲江池遗址公园/) },
  { category: "park.major_city_park", keywords: "浐灞国家湿地公园", accepts: typedNamed("11", /浐灞国家湿地公园/) },
  { category: "park.major_city_park", keywords: "西安植物园", accepts: typedNamed("11", /西安植物园/) },
  { category: "park.major_city_park", keywords: "莲湖公园", accepts: typedNamed("11", /^莲湖公园$/) },
  { category: "park.major_city_park", keywords: "汉城湖公园", accepts: typedNamed("11", /汉城湖公园/) },
  { category: "park.neighborhood_park", keywords: "口袋公园", allPages: true, accepts: typedNamed("1101", /(口袋|街心|街区|小).*公园/) },
  { category: "community.civic_service_center", keywords: "社区文化活动中心", allPages: true, accepts: named(/社区.*文化.*(活动)?中心/) },
  { category: "community.civic_service_center", keywords: "党群服务中心", allPages: true, accepts: named(/党群.*服务中心/) },
];
...
const WUHU_QUERIES: Query[] = [
  ...
  { category: "commerce.big_box_retail", keywords: "宜家家居", accepts: typedNamed("06", /宜家/) },
  { category: "commerce.big_box_retail", keywords: "开市客", accepts: typedNamed("06", /开市客|Costco/i) },
  { category: "commerce.large_mall", keywords: "购物中心", allPages: true, accepts: typedNamed("06", /购物中心|广场|万象|万达|吾悦|八佰伴|苏宁|星立方|金鹰|大悦城/) },
  { category: "transport.railway_station", keywords: "芜湖站", accepts: typedNamed("150200", /^芜湖站$/) },
  { category: "transport.railway_station", keywords: "芜湖北站", accepts: typedNamed("150200", /^芜湖北站$/) },
  { category: "transport.railway_station", keywords: "芜湖南站", accepts: typedNamed("150200", /^芜湖南站$/) },
  { category: "transport.airport", keywords: "芜湖宣州机场", accepts: typedNamed("150104", /芜湖宣州机场/) },
  { category: "landmark.city_landmark", keywords: "鸠兹古镇", accepts: named(/鸠兹古镇/) },
  { category: "landmark.city_landmark", keywords: "芜湖古城", accepts: named(/芜湖古城/) },
  { category: "landmark.city_landmark", keywords: "芜湖方特", accepts: named(/芜湖方特/) },
  { category: "landmark.city_landmark", keywords: "中山路步行街", accepts: named(/中山路步行街/) },
  { category: "landmark.city_landmark", keywords: "广济寺", accepts: named(/^广济寺$/) },
  { category: "landmark.city_landmark", keywords: "天门山景区", accepts: named(/天门山/) },
  { category: "park.major_city_park", keywords: "镜湖公园", accepts: typedNamed("11", /镜湖公园/) },
  { category: "park.major_city_park", keywords: "赭山公园", accepts: typedNamed("11", /赭山公园/) },
  { category: "park.major_city_park", keywords: "汀棠公园", accepts: typedNamed("11", /汀棠公园/) },
  { category: "park.major_city_park", keywords: "神山公园", accepts: typedNamed("11", /神山公园/) },
  { category: "park.major_city_park", keywords: "雕塑公园", accepts: typedNamed("11", /雕塑公园/) },
  { category: "park.neighborhood_park", keywords: "口袋公园", allPages: true, accepts: typedNamed("1101", /(口袋|街心|街区|小).*公园/) },
  { category: "community.civic_service_center", keywords: "社区文化活动中心", allPages: true, accepts: named(/社区.*文化.*(活动)?中心/) },
  { category: "community.civic_service_center", keywords: "党群服务中心", allPages: true, accepts: named(/党群.*服务中心/) },
];
